...
const CSS = [
  ...
  '.ssd3ov-toolbar{position:absolute;display:none;align-items:center;gap:8px;padding:6px 10px;border-radius:10px;background:rgba(26,32,42,.94);box-shadow:0 4px 16px rgba(0,0,0,.4);z-index:2;width:max-content}',
  '.ssd3ov-tool{display:grid;place-items:center;width:30px;height:30px;flex:none;border:none;border-radius:7px;background:transparent;color:#C7D3E3;cursor:pointer}',
  ...
  '.ssd3ov-tool-text{width:auto;padding:0 12px;flex:none;white-space:nowrap;font:13px/1.6 "Microsoft YaHei UI","PingFang SC","Segoe UI",sans-serif}',
  '.ssd3ov-sep{width:1px;height:20px;flex:none;background:rgba(255,255,255,.18)}',
  '.ssd3ov-done{padding:5px 16px;flex:none;white-space:nowrap;border:none;border-radius:14px;background:#2E6BE6;color:#fff;font:13px/1.6 "Microsoft YaHei UI","PingFang SC","Segoe UI",sans-serif;cursor:pointer}',
